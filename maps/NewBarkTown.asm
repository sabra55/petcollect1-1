...
NewBarkTown_MapEvents:
	...
	warp_event 13, 11, PLAYERS_HOUSE_1F, 1
	warp_event  3,  5, PLAYERS_NEIGHBORS_HOUSE, 1
	warp_event  7, 13, ELMS_HOUSE, 1
	...
	bg_event 16, 11, BGEVENT_READ, NewBarkTownPlayersHouseSign
	bg_event  7,  5, BGEVENT_READ, NewBarkTownElmsLabSign
	bg_event  5, 13, BGEVENT_READ, NewBarkTownElmsHouseSign

	def_object_events
	object_event  6,  8, SPRITE_TEACHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, NewBarkTownTeacherScript, -1
	object_event 10,  7, SPRITE_FISHER, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, NewBarkTownFisherScript, -1
